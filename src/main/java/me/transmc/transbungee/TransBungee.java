...
public final class TransBungee extends Plugin {
  ...
  public void onEnable() {
    ...
    getProxy().registerChannel(
        "trans:bungee"); // Register plugin message channel
    ...
    getProxy().getScheduler().schedule(this, new Runnable() {
      ...
      public void run() {
        ...
        System.out.println(C.yellow +
                           "Private messages HashMap has been cleared!");
      }
    }, 6, 0, TimeUnit.MINUTES);
  }
  ...
  public static TransBungee getInstance() { return instance; }

  public static BungeeApi getApi() { return api; }
}
